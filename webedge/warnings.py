WARNINGS = {
    ...
    "TITLE_TOO_SHORT":
    u"Avoid using extremely short titles "
    ...
    "TITLE_TOO_GENERIC":
    u"Avoid using default or vague titles like 'Untitled' or 'New Page 1'.",
    "TITLE_KEYWORD_STUFFED":
    u"Avoid stuffing unneeded keywords in your title tags.",
    "TITLE_DUPLICATED":
    u"Avoid using a duplicate title tag across your website.",
    "DESCRIPTION_MISSING":
    u"Description is missing.",
    ...
    u"Description is too generic.",
    "DESCRIPTION_KEYWORD_STUFFED":
    u"Avoid keyword stuffing in the description.",
    "DESCRIPTION_DUPLICATED":
    u"Avoid using a duplicate description across your website.",
    "URL_TOO_LONG":
    u"Avoid using URLs with unnecessary parameters and IDs.",
    "URL_TOO_GENERIC":
    u"Avoid choosing generic page names like 'page1.html'.",
    "URL_KEYWORD_STUFFED":
    u"Avoid keyword stuffing in the url.",
    "URL_TOO_DEEP":
    u"Avoid having deep nesting of subdirectories (more than 3 levels deep) "
    u"like '.../dir1/dir2/dir3/dir4/dir5/dir6/page.html'.",
    "URL_NOT_CANONICAL":
    u"Only one version of a URL (Canonical URL) "
    ...
    "IMAGE_LINK_ALT_MISSING":
    u"Image link missing Alt tag.",
    "ANCHOR_TEXT_MISSING":
    u"Anchor missing title tag or text.",
    "ANCHOR_TEXT_TOO_SHORT":
    u"Anchor text too short (less than 3 characters).",
    "ANCHOR_TEXT_TOO_LONG":
    u"Avoid using lengthy links with unnecessary parameters "
    u"(more than 80 characters).",
    "ANCHOR_TEXT_TOO_GENERIC":
    u"Anchor text contains generic text.",
    "ANCHOR_HREF_TOO_LONG":
    u"Avoid using lengthy links with unnecessary parameters "
...
BADGES = {
    ...
    u"Description is informative and helps give context to "
    u"customers trying to get to your page.",
    "URL_CANONICAL":
    u"Using canonical URLs helps avoid duplicate content.",
    "URL_CORRECTLY_CASED":
    u"URL is lowercase. Many users expect lower-case URLs and "
    u"remember them better.",
    "IMAGE_LINK_ALT":
    u"Image link contains an alt tag.",
    "ANCHOR_NO_FOLLOW":
